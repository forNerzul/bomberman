...
def crear_incidente():
    ...
    if request.method == 'POST':
        ...
        incidente = Inicidente(operador=operador, movil_id=movil_id, servicio=servicio, tipo_servicio=tipo_servicio, salida=salida, llegada=llegada, lugar=lugar, observaciones=observaciones)
...
def incidentes():
    incidentes = Inicidente.query.all()
